...
const STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    canSkip: false, // cannot skip corporate KYC
    fields: [
      { id: "companyName", label: "Company Name", type: "text", placeholder: "e.g. Acme Holdings (Pty) Ltd", required: true, aiHint: "businessName" },
      { id: "companyRegistration", label: "Company Registration Number (CIPC)", type: "text", placeholder: "e.g. 2023/123456/07", required: true },
      { id: "vatNumber", label: "VAT Number (if VAT-registered)", type: "text", placeholder: "e.g. 4123456789", required: false },
      {
        id: "legalStructure",
        label: "Legal Structure",
        type: "select",
        options: ["Pty Ltd", "CC (Close Corporation)", "NPC / Non-Profit", "Sole Proprietor", "Partnership", "Trust", "Public Company"],
        required: true,
      },
      {
        id: "industry",
      ...
      { id: "signatoryName", label: "Authorised Signatory (Full Name)", type: "text", placeholder: "Person signing on behalf of the company", required: true },
      { id: "signatoryRole", label: "Signatory Role / Title", type: "text", placeholder: "e.g. CFO, Managing Director", required: true },
      ...
      { id: "hrContactPhone", label: "HR Contact Phone", type: "tel", placeholder: "+27 11 123 4567", required: true },
      { id: "billingContactEmail", label: "Billing Contact Email (invoices)", type: "email", placeholder: "accounts@company.co.za", required: true },
      { id: "billingAddress", label: "Billing Address", type: "text", placeholder: "Street, Suburb, City, Postal Code", required: true },
