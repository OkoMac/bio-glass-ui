      ...
      <div className="fixed inset-0 z-[100] bg-obsidian overflow-y-auto">
        <div className="max-w-lg mx-auto px-4 md:px-8 py-12 space-y-6">
          ...
          {[
            ...
            { title: "5. Fees, Payments & Financial Terms", text: "Client Booking Fee: 5% of the service price is charged to clients on each booking (3.5% for Premium subscribers at R29/month). Provider Platform Fee: 5% of the service price is deducted from provider earnings. A further 5% is ring-fenced as an acquisition-marketing contribution to the provider's own voucher pool. Provider net payout: 90% of the bill. Wallet Cash-out: 10% fee, minimum R200. Subscriptions: Client Premium R29/month, Provider Pro R499/month, Provider Elite R999/month. All payments are processed through Paystack, a licensed payment service provider. BION does not hold client or provider funds — Paystack manages settlement. All prices are in South African Rand (ZAR) and inclusive of VAT where applicable." },
            ...
            { title: "9. Privacy & Data Protection (POPIA)", text: "BION complies with the Protection of Personal Information Act 4 of 2013 (POPIA). We act as the 'responsible party' for platform data and as an 'operator' when processing data on behalf of providers. We collect and process personal information solely for: providing platform services, processing payments, improving user experience, and communicating with you. Your rights under POPIA include: the right to access your personal information, the right to correction of inaccurate information, the right to deletion of your information, the right to object to processing, the right to lodge a complaint with the Information Regulator. We implement appropriate technical and organisational security measures. We do not sell personal information to third parties. Data may be shared with Supabase (database, hosted in South Africa), Paystack (payments, South Africa), and Google (authentication) as necessary service providers. Food images submitted for calorie estimation are processed by a third-party AI service (OpenAI) and are not stored — images are analysed and immediately discarded. Health data including routines, medication schedules, and biometrics are classified as special personal information under POPIA Section 26 and are processed only with your explicit consent." },
