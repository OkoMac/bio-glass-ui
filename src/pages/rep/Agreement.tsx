...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      "20% of every provider subscription for providers you sign up, paid monthly while the subscription is active. This is R99.80/month on a Pro plan (R499) and R199.80/month on an Elite plan (R999).",
