...
export default function LifeCoach() {
  ...
  return (
    <div className="min-h-screen bg-obsidian bg-obsidian-glow flex flex-col">
      ...
      <div
        ref={scrollRef}
        className="flex-1 overflow-y-auto px-4 pb-4 mx-auto max-w-lg md:max-w-3xl xl:max-w-7xl w-full space-y-3"
      >
      ...
      {/* Input bar */}
      <div className="mx-auto max-w-lg md:max-w-3xl xl:max-w-7xl w-full px-4 pb-40 pt-2">
