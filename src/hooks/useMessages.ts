...
export function useMessages(partnerId: string | null) {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on("postgres_changes", { event: "INSERT", schema: "public", table: "messages" }, (payload: any /* TODO(types) */) => {
      ...
      .on("postgres_changes", { event: "UPDATE", schema: "public", table: "messages" }, (payload: any /* TODO(types) */) => {
